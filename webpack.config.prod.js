...
https://medium.com/@okonetchnikov/
long-term-caching-of-static-assets-with-webpack-1ecb139adb95#.w99i89nsz
*/
...
export default {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      inject: true,
      // Note that you can add custom options here if you
      // need to handle other custom logic in index.html
      // To track JavaScript errors via TrackJS, sign up for
      // a free trial at TrackJS.com and enter your token below.
      trackJSToken: ''
    }),
